...
func (x *QueryResult_SyntaxErrorDetail) Equal(y *QueryResult_SyntaxErrorDetail) bool {
	if x == y {
		return true
	}
	if x == nil || y == nil {
	...
	if !x.Position.Equal(y.Position) {
		return false
	}
	return true
}

func (x *QueryResult_PermissionDeniedDetail) Equal(y *QueryResult_PermissionDeniedDetail) bool {
	if x == y {
		return true
	}
	if x == nil || y == nil {
